...
void Test::saveToCSV(const std::string& filename, const std::vector<std::vector<std::string>>& data) {
    ...
    outFile << "Rozmiar instancji (liczba maszyn i zadań),przedział p_j,"
            ...
            << "Wartość kryterium PD i przeglądu zupełnego,Czas dział. alg. PD [μs],"
